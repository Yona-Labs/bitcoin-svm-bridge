...
pub struct ForkState {
    ...
    pub start_height: u32, // Block height of last block that is also in main chain
    pub length: u32,      //Current length of the fork

    pub tip_commit_hash: [u8; 32], // Block header data commitment hash for the latest block - fork tip
